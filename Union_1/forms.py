...
class Become_a_Member(forms.ModelForm):
    ...
    mobile_phone=forms.CharField(widget=forms.TextInput(attrs={'class' : 'form-control'}))
    home_phone=forms.CharField(widget=forms.TextInput(attrs={'class' : 'form-control'}))
    home_fax=forms.CharField(widget=forms.TextInput(attrs={'class' : 'form-control'}))
    email=forms.EmailField(widget=forms.TextInput(attrs={'class' : 'form-control'}))
    ...
    if_not_alsace_Reason=forms.CharField(widget=forms.Textarea(attrs={'class' : 'form-control', 'rows' : '6'}))
    ...
    first_sponsor=forms.CharField(widget=forms.TextInput(attrs={'class' : 'form-control'}))
    second_sponsor=forms.CharField(widget=forms.TextInput(attrs={'class' : 'form-control'}))
